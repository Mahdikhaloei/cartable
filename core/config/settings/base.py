"""
Base Cartable settings to build other settings files upon.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("DATABASE_NAME", default="cartable_db"),
...
SWAGGER_SETTINGS = {
    ...
    "base_url": env.str("SWAGGER_BASE_URL", default="https://cartable.co"),
}
